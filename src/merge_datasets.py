"""
Merges CIFAKE and a downloaded SID_Set subset into one combined dataset,
in the same root_dir/split/{REAL,FAKE} layout that dataset.py expects.
...
def merge(args):
    ...
    for cls in ["REAL", "FAKE"]:
        ...
        print(f"  {cls}: {n_cifake} from CIFAKE + {n_sid} from SID_Set = {n_cifake + n_sid} total")
